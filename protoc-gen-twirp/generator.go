...
import (
	...
	"github.com/lo5/twirp/internal/gen/stringutils"
	"github.com/lo5/twirp/internal/gen/typemap"
...
func (t *twirp) generateFileHeader(file *descriptor.FileDescriptorProto) {
	...
	if t.filesHandled == 0 {
		...
		t.P("This code was generated with github.com/lo5/twirp/protoc-gen-twirp ", gen.Version, ".")
		t.P()
...
func (t *twirp) generateImports(file *descriptor.FileDescriptorProto) {
	...
	t.P(`import `, t.pkgs["twirp"], ` "github.com/lo5/twirp"`)
	t.P(`import `, t.pkgs["ctxsetters"], ` "github.com/lo5/twirp/ctxsetters"`)
	t.P()
